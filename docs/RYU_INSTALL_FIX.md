...
Update: fixed a heredoc/Python patching syntax error in scripts/install_ryu_patched.sh that caused `SyntaxError: unterminated string literal` during bootstrap.
